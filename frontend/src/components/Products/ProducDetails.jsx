...
// total reviews of shop

const specificShopProducts = products?.filter((product) => product?.shop?._id === data?.shop?._id);
const totalReviewsLength = specificShopProducts?.reduce((acc, product) => acc + product.reviews.length, 0);

// total ratings of shop
const totalRatings = specificShopProducts && specificShopProducts.reduce((acc,product) => acc + product.reviews.reduce((sum,review)=> sum + review.rating,0),0);

// average rating of shop
    ...
    <div className="bg-white ">
      {data ? (
         ...
         <div className="w-full py-5">
          ...
          <ProductDetailsInfo data={data} products={products} user={user} totalReviewsLength={totalReviewsLength} averageRating={averageRating}/>
        </div>
      ) : null}
    </div>
  );
